...
Type hints and async/await usage are canonical in [`AGENTS.md` → Code Conventions](../AGENTS.md#code-conventions); flag unannotated signatures and inconsistent async/await for I/O.
...
2. **CHANGELOG.md**: Generated by semantic-release (see [`AGENTS.md` → Code Conventions](../AGENTS.md#code-conventions)); flag manual edits.
