...
**ha-mcp** is a Model Context Protocol (MCP) server that enables AI assistants to control Home Assistant smart homes. It provides 65+ tools for entity control, automations, device management, and configuration via Home Assistant's REST and WebSocket APIs.
...
**Code Organization:**
- `src/ha_mcp/tools/` - 65+ MCP tools (tool modules auto-discovered)
