...
class TestThreeRouteWarningSuffix:
    ...
    The attach_skill_payload parameter is intentionally NOT mentioned because it
    ...
    def test_warning_does_not_mention_attach_skill_payload_param(self):
        """The hidden attach_skill_payload param must NOT appear in warnings —
        ...
        msg = self._first_warning()
        assert "attach_skill_payload" not in msg
    ...
    def test_custom_prefix_replaces_skill_uri_keeps_tool_route(self):
        ...
        # attach_skill_payload remains hidden from the LLM
        assert "attach_skill_payload" not in msg
