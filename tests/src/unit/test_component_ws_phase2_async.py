...
class TestCapabilityPresence:
    ...
    def test_component_version(self):
        # Pending 1.2.4 (bumped for the extra-YAML-write-keys service field,
        # #1887). Capabilities are advertised by name, never version-inferred,
        # so new caps ride any pending version without a bump; this assertion
        # just pins the declared version (the write caps shipped in 1.2.1).
