...
_SKIP_CEILING_PER_LANE = {
    ...
    "haos_inaddon": 62,  # was 59 (in-process MCP server); +3 entity-visibility round-2 @external_only e2e (allowlist-positive/deny-wins, overview, assist-unexpose) that skip on this lane
