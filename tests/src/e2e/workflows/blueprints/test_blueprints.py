...
@pytest.mark.blueprint
@pytest.mark.slow
async def test_import_and_save_blueprint(mcp_client):
    """
    Test: Import a blueprint from URL and verify it is saved.

    Validates the full import workflow (issue #685):
    1. Import blueprint from a URL (blueprint/import + blueprint/save)
    2. Verify the blueprint appears in the list
    3. Clean up by deleting the imported blueprint
    """
    logger.info("Testing ha_import_blueprint full import+save workflow...")
