...
const ADVANCED_FIELD_META = {
  ...
  ha_tool_concurrency: { label: "HA tool concurrency",         help: "Optional limit on concurrent Home Assistant tool calls across all MCP sessions. 0 keeps unlimited behavior. Range 0–32. Restart required." },
