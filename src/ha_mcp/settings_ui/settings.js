...
const ADVANCED_FIELD_META = {
  ...
  entity_search_limit: { label: "Entity search result limit",  help: "Max entities returned by ha_search. Range 1–1000." },
  automation_config_time_budget: { label: "Automation config time budget (s)", help: "Max seconds ha_search spends fetching automation configs before returning a partial result. Raise on instances with many automations. Range 1–600. Restart required." },
  script_config_time_budget:     { label: "Script config time budget (s)",     help: "Max seconds ha_search spends fetching script configs before returning a partial result. Range 1–600. Restart required." },
  scene_config_time_budget:      { label: "Scene config time budget (s)",      help: "Max seconds ha_search spends fetching scene configs before returning a partial result. Range 1–600. Restart required." },
