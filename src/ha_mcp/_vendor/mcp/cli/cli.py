...
from ha_mcp._vendor.mcp.server import MCPServer
from ha_mcp._vendor.mcp.server import Server as LowLevelServer
...
try:
    from ha_mcp._vendor.mcp.cli import claude
