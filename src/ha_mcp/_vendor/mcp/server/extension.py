...
from ha_mcp._vendor.mcp_types import CallToolRequestParams
...
from ha_mcp._vendor.mcp.shared.extension import validate_extension_identifier as validate_extension_identifier

if TYPE_CHECKING:
    from ha_mcp._vendor.mcp.server.mcpserver.resources import Resource
