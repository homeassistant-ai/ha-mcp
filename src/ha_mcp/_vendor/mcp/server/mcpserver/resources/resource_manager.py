...
from ha_mcp._vendor.mcp.server.mcpserver.exceptions import ResourceNotFoundError
from ha_mcp._vendor.mcp.server.mcpserver.resources.base import Resource
from ha_mcp._vendor.mcp.server.mcpserver.resources.templates import (
