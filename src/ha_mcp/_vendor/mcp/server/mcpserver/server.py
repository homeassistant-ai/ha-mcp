...
from ha_mcp._vendor.mcp_types import Prompt as MCPPrompt
from ha_mcp._vendor.mcp_types import PromptArgument as MCPPromptArgument
from ha_mcp._vendor.mcp_types import Resource as MCPResource
from ha_mcp._vendor.mcp_types import ResourceTemplate as MCPResourceTemplate
from ha_mcp._vendor.mcp_types import Tool as MCPTool
...
from ha_mcp._vendor.mcp.server.auth.middleware.auth_context import AuthContextMiddleware
from ha_mcp._vendor.mcp.server.auth.middleware.bearer_auth import BearerAuthBackend, RequireAuthMiddleware
from ha_mcp._vendor.mcp.server.auth.provider import OAuthAuthorizationServerProvider, ProviderTokenVerifier, TokenVerifier
from ha_mcp._vendor.mcp.server.auth.settings import AuthSettings
from ha_mcp._vendor.mcp.server.caching import CacheableMethod, CacheHint
from ha_mcp._vendor.mcp.server.context import HandlerResult, ServerMiddleware, ServerRequestContext
from ha_mcp._vendor.mcp.server.extension import (
    Extension,
    MethodBinding,
    RequestHandler,
...
from ha_mcp._vendor.mcp.server.lowlevel.helper_types import ReadResourceContents
from ha_mcp._vendor.mcp.server.lowlevel.server import LifespanResultT, Server
from ha_mcp._vendor.mcp.server.lowlevel.server import lifespan as default_lifespan
from ha_mcp._vendor.mcp.server.mcpserver.context import Context
from ha_mcp._vendor.mcp.server.mcpserver.exceptions import (
    ResourceError,
...
from ha_mcp._vendor.mcp.server.mcpserver.prompts import Prompt, PromptManager
from ha_mcp._vendor.mcp.server.mcpserver.resources import (
...
from ha_mcp._vendor.mcp.server.mcpserver.tools import Tool, ToolManager
from ha_mcp._vendor.mcp.server.mcpserver.utilities.context_injection import find_context_parameter
from ha_mcp._vendor.mcp.server.mcpserver.utilities.logging import configure_logging, get_logger
from ha_mcp._vendor.mcp.server.request_state import RequestStateBoundary, RequestStateSecurity
from ha_mcp._vendor.mcp.server.sse import SseServerTransport
from ha_mcp._vendor.mcp.server.stdio import stdio_server
from ha_mcp._vendor.mcp.server.streamable_http import EventStore
from ha_mcp._vendor.mcp.server.streamable_http_manager import (
    DEFAULT_MAX_SESSIONS,
    DEFAULT_SESSION_IDLE_TIMEOUT,
    StreamableHTTPSessionManager,
)
from ha_mcp._vendor.mcp.server.subscriptions import InMemorySubscriptionBus, ListenHandler, SubscriptionBus
from ha_mcp._vendor.mcp.server.transport_security import DEFAULT_MAX_REQUEST_BODY_SIZE, TransportSecuritySettings
from ha_mcp._vendor.mcp.shared.exceptions import MCPError
from ha_mcp._vendor.mcp.shared.uri_template import UriTemplate
        ...
        *,
        ...
        if self.settings.auth:  # pragma: no cover
            ...
            if self._auth_server_provider:
                from ha_mcp._vendor.mcp.server.auth.routes import create_auth_routes
        ...
        if self._token_verifier:  # pragma: no cover
            ...
            if self.settings.auth and self.settings.auth.resource_server_url:
                from ha_mcp._vendor.mcp.server.auth.routes import build_resource_metadata_url
        ...
        if self.settings.auth and self.settings.auth.resource_server_url:  # pragma: no cover
            from ha_mcp._vendor.mcp.server.auth.routes import create_protected_resource_routes
