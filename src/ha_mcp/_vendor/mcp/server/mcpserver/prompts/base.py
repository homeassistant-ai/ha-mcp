...
from ha_mcp._vendor.mcp_types import ContentBlock, Icon, InputRequiredResult, TextContent
...
from ha_mcp._vendor.mcp.server.mcpserver.utilities.types import Audio, Image
