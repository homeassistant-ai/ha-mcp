...
from ha_mcp._vendor.mcp.server.auth.errors import stringify_pydantic_error
from ha_mcp._vendor.mcp.server.auth.json_response import PydanticJSONResponse
from ha_mcp._vendor.mcp.server.auth.provider import OAuthAuthorizationServerProvider, RegistrationError, RegistrationErrorCode
from ha_mcp._vendor.mcp.server.auth.settings import ClientRegistrationOptions
from ha_mcp._vendor.mcp.shared.auth import JWT_BEARER_GRANT_TYPE, OAuthClientInformationFull, OAuthClientMetadata
