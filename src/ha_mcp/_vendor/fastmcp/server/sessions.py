...
from ha_mcp._vendor.fastmcp.server.dependencies import get_access_token, get_server, get_session
...
if TYPE_CHECKING:
    ...
    from ha_mcp._vendor.fastmcp.server.server import StateValue
