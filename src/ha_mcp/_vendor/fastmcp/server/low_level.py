...
from ha_mcp._vendor.mcp.server.context import (
    CallNext,
    HandlerResult,
    ServerMiddleware,
    ServerRequestContext,
)
from ha_mcp._vendor.mcp.server.lowlevel.server import (
    LifespanResultT,
    NotificationOptions,
)
from ha_mcp._vendor.mcp.server.lowlevel.server import (
...
from ha_mcp._vendor.mcp.server.stdio import stdio_server as stdio_server
from ha_mcp._vendor.mcp.shared.exceptions import MCPError
from pydantic import ValidationError

from ha_mcp._vendor.fastmcp.apps.config import UI_EXTENSION_ID
from ha_mcp._vendor.fastmcp.server.telemetry import seam_span
from ha_mcp._vendor.fastmcp.utilities.logging import get_logger

if TYPE_CHECKING:
    from ha_mcp._vendor.fastmcp.server.middleware import CallNext as FastMCPCallNext
...
class FastMCPServerMiddleware:
    ...
    async def __call__(
        ...
        from ha_mcp._vendor.fastmcp.server.dependencies import bind_request_context
    ...
    async def _dispatch_component(
        ...
        """
        from ha_mcp._vendor.fastmcp.server.middleware.middleware import _interior_dispatched
