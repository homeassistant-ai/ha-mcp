...
from ha_mcp._vendor.mcp.server.streamable_http import (
    EventStore,
)
from ha_mcp._vendor.mcp.server.streamable_http_manager import StreamableHTTPSessionManager
...
from ha_mcp._vendor.fastmcp.server.auth import AuthProvider
from ha_mcp._vendor.fastmcp.server.auth.middleware import RequireAuthMiddleware
from ha_mcp._vendor.fastmcp.server.session_scoped_event_store import SessionScopedEventStore
...
class RequestContextMiddleware:
    ...
    async def __call__(self, scope, receive, send):
        if scope["type"] == "http":
            from ha_mcp._vendor.fastmcp.server.context import reset_transport, set_transport
