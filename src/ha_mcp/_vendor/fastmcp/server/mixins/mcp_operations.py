...
from ha_mcp._vendor.fastmcp.utilities.pagination import paginate_sequence
from ha_mcp._vendor.fastmcp.utilities.versions import VersionSpec, dedupe_with_versions
...
def _version_from_ctx(ctx: ServerRequestContext) -> VersionSpec | None:
    ...
    from ha_mcp._vendor.fastmcp.server.dependencies import _lift_meta
...
class MCPOperationsMixin:
    ...
    async def _on_set_logging_level(
        ...
        """
        from ha_mcp._vendor.fastmcp.server.context import _log_level_session_key
