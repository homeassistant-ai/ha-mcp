...
import anyio
import uvicorn
from ha_mcp._vendor.mcp.server.lowlevel.server import NotificationOptions
...
from ha_mcp._vendor.fastmcp.server.http import (
...
from ha_mcp._vendor.fastmcp.server.providers.wrapped_provider import _WrappedProvider
from ha_mcp._vendor.fastmcp.utilities.logging import get_logger, temporary_log_level

if TYPE_CHECKING:
    from ha_mcp._vendor.fastmcp.server.server import FastMCP, Transport
...
class TransportMixin:
    ...
    async def run_stdio_async(
        ...
        if show_banner:
            from ha_mcp._vendor.fastmcp.utilities.cli import log_server_banner
