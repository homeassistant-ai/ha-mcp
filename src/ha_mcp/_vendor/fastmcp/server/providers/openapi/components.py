...
from ha_mcp._vendor.fastmcp.resources import (
    Resource,
    ResourceContent,
    ResourceResult,
    ResourceTemplate,
...
from ha_mcp._vendor.fastmcp.utilities.exceptions import is_request_error, is_timeout_error
from ha_mcp._vendor.fastmcp.utilities.logging import get_logger
from ha_mcp._vendor.fastmcp.utilities.openapi import HTTPRoute
...
if TYPE_CHECKING:
    from ha_mcp._vendor.fastmcp.server import Context
