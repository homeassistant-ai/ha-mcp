...
class FastMCPProvider(Provider):
    ...
    async def get_app_tool(self, app_name: str, tool_name: str) -> Tool | None:
        ...
        from ha_mcp._vendor.fastmcp.server.providers.addressing import hashed_backend_name
    ...
    async def lifespan(self) -> AsyncIterator[None]:
        ...
        """
        from ha_mcp._vendor.fastmcp.server.mixins.lifespan import _lifespan_root_active
