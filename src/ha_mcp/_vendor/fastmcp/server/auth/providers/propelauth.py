...
from ha_mcp._vendor.fastmcp.server.auth import AccessToken, RemoteAuthProvider
from ha_mcp._vendor.fastmcp.server.auth.providers.introspection import IntrospectionTokenVerifier
