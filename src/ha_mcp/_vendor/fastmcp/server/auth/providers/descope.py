...
from ha_mcp._vendor.mcp.server.auth.routes import build_resource_metadata_url, cors_middleware
from ha_mcp._vendor.mcp.shared.auth import ProtectedResourceMetadata
from pydantic import AnyHttpUrl
from starlette.requests import Request
from starlette.responses import JSONResponse, Response
from starlette.routing import Route

from ha_mcp._vendor.fastmcp.server.auth import RemoteAuthProvider, TokenVerifier
