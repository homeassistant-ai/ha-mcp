...
from ha_mcp._vendor.fastmcp.server.auth import AccessToken, TokenVerifier
from ha_mcp._vendor.fastmcp.server.auth.ssrf import SSRFError, SSRFFetchError, ssrf_safe_fetch
from ha_mcp._vendor.fastmcp.utilities.auth import decode_jwt_header, parse_scopes
