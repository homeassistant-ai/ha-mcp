...
from ha_mcp._vendor.mcp.server.auth.handlers.authorize import (
...
from ha_mcp._vendor.fastmcp.server.auth.redirect_validation import build_client_redirect
from ha_mcp._vendor.fastmcp.utilities.logging import get_logger
from ha_mcp._vendor.fastmcp.utilities.ui import (
    INFO_BOX_STYLES,
    TOOLTIP_STYLES,
    create_logo,
    create_page,
...
class AuthorizationHandler(SDKAuthorizationHandler):
    ...
    async def _create_enhanced_error_response(
        ...
        if "text/html" in accept:
            ...
            from ha_mcp._vendor.mcp.server.auth.handlers.authorize import AuthorizationErrorResponse
