...
from ha_mcp._vendor.mcp.server.auth.handlers.metadata import MetadataHandler
from ha_mcp._vendor.mcp.server.auth.handlers.register import RegistrationHandler
from ha_mcp._vendor.mcp.server.auth.middleware.client_auth import ClientAuthenticator
...
from ha_mcp._vendor.mcp.server.auth.routes import build_metadata, cors_middleware
from ha_mcp._vendor.mcp.server.auth.settings import (
    ClientRegistrationOptions,
    RevocationOptions,
)
from ha_mcp._vendor.mcp.shared.auth import (
...
from ha_mcp._vendor.fastmcp import settings
...
from ha_mcp._vendor.fastmcp.server.auth.cimd import CIMDClientManager
from ha_mcp._vendor.fastmcp.server.auth.handlers.authorize import AuthorizationHandler
from ha_mcp._vendor.fastmcp.server.auth.identity_assertion import (
...
from ha_mcp._vendor.fastmcp.server.auth.jwt_issuer import (
    JWTIssuer,
    derive_jwt_key,
)
from ha_mcp._vendor.fastmcp.server.auth.oauth_proxy.consent import ConsentMixin
...
from ha_mcp._vendor.fastmcp.server.auth.oauth_proxy.ui import create_error_html
from ha_mcp._vendor.fastmcp.server.auth.oauth_proxy.upstream import AsyncOAuth2Client
from ha_mcp._vendor.fastmcp.server.auth.redirect_validation import (
    build_client_redirect,
    is_redirect_uri_allowed_for_application_type,
    validate_redirect_uri,
)
from ha_mcp._vendor.fastmcp.utilities.auth import parse_scopes
