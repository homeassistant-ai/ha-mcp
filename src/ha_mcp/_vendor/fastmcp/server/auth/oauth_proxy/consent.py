...
from ha_mcp._vendor.fastmcp.server.auth.oauth_proxy.ui import create_consent_html
...
from ha_mcp._vendor.fastmcp.utilities.ui import create_secure_html_response

if TYPE_CHECKING:
    from ha_mcp._vendor.fastmcp.server.auth.oauth_proxy.proxy import OAuthProxy
