...
from ha_mcp._vendor.mcp.server.auth.handlers.token import TokenErrorResponse
from ha_mcp._vendor.mcp.server.auth.handlers.token import TokenHandler as _SDKTokenHandler
...
from ha_mcp._vendor.mcp.server.auth.middleware.bearer_auth import BearerAuthBackend
from ha_mcp._vendor.mcp.server.auth.middleware.client_auth import (
    AuthenticationError,
    ClientAuthenticator,
)
from ha_mcp._vendor.mcp.server.auth.middleware.client_auth import (
...
from ha_mcp._vendor.mcp.server.auth.routes import (
    build_metadata,
    cors_middleware,
    create_auth_routes,
...
from ha_mcp._vendor.mcp.shared.auth import JWT_BEARER_GRANT_TYPE, OAuthClientInformationFull
