...
from ha_mcp._vendor.fastmcp.server.auth.redirect_validation import matches_allowed_pattern
from ha_mcp._vendor.fastmcp.server.auth.ssrf import (
    SSRFError,
    SSRFFetchError,
...
class CIMDAssertionValidator:
    ...
    def __init__(self):
        ...
        self.logger = get_logger(__name__.removeprefix("ha_mcp._vendor."))
    ...
    async def validate_assertion(
        ...
        """
        from ha_mcp._vendor.fastmcp.server.auth.providers.jwt import JWTVerifier as _JWTVerifier
