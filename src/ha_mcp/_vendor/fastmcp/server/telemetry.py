...
from ha_mcp._vendor.fastmcp.exceptions import ToolError as _ToolError
from ha_mcp._vendor.fastmcp.telemetry import (
...
def get_session_span_attributes() -> dict[str, str]:
    ...
    from ha_mcp._vendor.fastmcp.server.dependencies import get_context
...
def get_protocol_span_attributes() -> dict[str, str]:
    ...
    """
    from ha_mcp._vendor.fastmcp.server.dependencies import fastmcp_request_ctx
