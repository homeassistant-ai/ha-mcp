...
from ha_mcp._vendor.mcp_types.methods import SPEC_CLIENT_METHODS
from pydantic import BaseModel

from ha_mcp._vendor.fastmcp.server.dependencies import _lift_meta, bind_request_context

if TYPE_CHECKING:
    from ha_mcp._vendor.fastmcp.server.context import Context
    from ha_mcp._vendor.fastmcp.server.server import FastMCP
    from ha_mcp._vendor.fastmcp.tools.base import ToolResult
