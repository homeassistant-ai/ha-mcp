...
from ha_mcp._vendor.mcp import LoggingLevel, ServerSession
from ha_mcp._vendor.mcp.server.context import ServerRequestContext
from ha_mcp._vendor.mcp_types import (
    GetPromptResult,
)
from ha_mcp._vendor.mcp_types import Prompt as SDKPrompt
from ha_mcp._vendor.mcp_types import Resource as SDKResource
...
from ha_mcp._vendor.fastmcp.resources.base import ResourceResult
from ha_mcp._vendor.fastmcp.server.dependencies import FastMCPRequestContext, fastmcp_request_ctx
from ha_mcp._vendor.fastmcp.server.elicitation import (
    AcceptedElicitation,
...
from ha_mcp._vendor.fastmcp.server.low_level import client_supports_extension
from ha_mcp._vendor.fastmcp.server.server import FastMCP, StateValue
from ha_mcp._vendor.fastmcp.server.transforms.visibility import (
    Visibility,
)
from ha_mcp._vendor.fastmcp.server.transforms.visibility import (
...
from ha_mcp._vendor.fastmcp.utilities.logging import _clamp_logger, get_logger
from ha_mcp._vendor.fastmcp.utilities.versions import VersionSpec

logger: Logger = get_logger(name=__name__.removeprefix("ha_mcp._vendor."))
...
class Context:
    ...
    async def __aenter__(self) -> Context:
        ...
        from ha_mcp._vendor.fastmcp.server.dependencies import _current_server, is_docket_available
    ...
    def client_extension_settings(self, identifier: str) -> dict[str, Any] | None:
        ...
        if rc is None:
            return None
        from ha_mcp._vendor.fastmcp.server.extensions import _extract_client_extension_settings
    ...
    async def report_progress(
        ...
        from ha_mcp._vendor.fastmcp.server.dependencies import is_docket_available
    ...
    def session_id(self) -> str:
        ...
        if request_ctx is not None:
            ...
            from ha_mcp._vendor.fastmcp.server.dependencies import _background_task_session_id
