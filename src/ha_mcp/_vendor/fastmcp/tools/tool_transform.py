...
from ha_mcp._vendor.fastmcp.tools.function_parsing import ParsedFunction
from ha_mcp._vendor.fastmcp.utilities.async_utils import (
    call_sync_fn_in_threadpool,
    is_coroutine_function,
)
from ha_mcp._vendor.fastmcp.utilities.components import _convert_set_default_none
...
def _set_visibility_metadata(tool: Tool, *, enabled: bool) -> None:
    ...
    from ha_mcp._vendor.fastmcp.server.transforms.visibility import _FASTMCP_KEY, _INTERNAL_KEY
