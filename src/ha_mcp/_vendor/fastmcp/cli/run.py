...
from ha_mcp._vendor.fastmcp.server.server import FastMCP, create_proxy
from ha_mcp._vendor.fastmcp.utilities.logging import get_logger
from ha_mcp._vendor.fastmcp.utilities.mcp_server_config import (
    MCPServerConfig,
)
...
async def run_command(
    ...
    # Special case: MCPConfig files (legacy)
        ...
        if "mcpServers" in data:
            ...
            from ha_mcp._vendor.fastmcp.cli.cli import with_argv
