...
from ha_mcp._vendor.fastmcp.cli.discovery import DiscoveredServer, discover_servers, resolve_name
from ha_mcp._vendor.fastmcp.client.client import CallToolResult, Client
from ha_mcp._vendor.fastmcp.client.elicitation import ElicitResult
from ha_mcp._vendor.fastmcp.client.transports.base import ClientTransport
...
from ha_mcp._vendor.fastmcp.client.transports.stdio import StdioTransport
...
async def _terminal_elicitation_handler(
    ...
    """
    from ha_mcp._vendor.mcp_types import ElicitRequestFormParams
