...
from ha_mcp._vendor.fastmcp.cli import run as run_module
from ha_mcp._vendor.fastmcp.cli.auth import auth_app
from ha_mcp._vendor.fastmcp.cli.client import call_command, discover_command, list_command
from ha_mcp._vendor.fastmcp.cli.deploy.command import login, logout, whoami
from ha_mcp._vendor.fastmcp.cli.generate import generate_cli_command
from ha_mcp._vendor.fastmcp.cli.install import install_app
from ha_mcp._vendor.fastmcp.utilities.cli import is_already_in_uv_subprocess, load_and_merge_config
from ha_mcp._vendor.fastmcp.utilities.inspect import (
    InspectFormat,
    format_info,
    inspect_fastmcp,
)
from ha_mcp._vendor.fastmcp.utilities.logging import get_logger
from ha_mcp._vendor.fastmcp.utilities.mcp_server_config import MCPServerConfig
from ha_mcp._vendor.fastmcp.utilities.version_check import check_for_newer_version
...
async def apps(
    ...
    *,
    ...
    from ha_mcp._vendor.fastmcp.cli.apps_dev import run_dev_apps
    ...
    *server_args: str,
    ...
    if module:
        ...
        if not skip_env and not is_already_in_uv_subprocess():
            from ha_mcp._vendor.fastmcp.utilities.mcp_server_config.v1.environments.uv import (
                UVEnvironment,
            )
