...
from ha_mcp._vendor.fastmcp.cli.deploy.horizon_client import HorizonClient, normalize_api_origin
from ha_mcp._vendor.fastmcp.cli.deploy.state import (
    StateFileError,
    read_state,
    remove_state,
    state_lock,
...
class CredentialStore:
    ...
    def save_for_origin(
        ...
        *,
        ...
        from ha_mcp._vendor.fastmcp.cli.deploy.configuration import ConfigurationStore
