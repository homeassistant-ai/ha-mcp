...
from ha_mcp._vendor.mcp.client.auth.extensions.client_credentials import (
...
from ha_mcp._vendor.mcp.client.auth.utils import extract_field_from_www_auth
from typing_extensions import override

from ha_mcp._vendor.fastmcp.client.auth.oauth import TokenStorageAdapter
