...
from ha_mcp._vendor.fastmcp.mcp_config import (
    MCPConfig,
    MCPServerTypes,
    RemoteMCPServer,
    StdioMCPServer,
...
class MCPConfigTransport(ClientTransport):
    ...
    def __init__(self, config: MCPConfig | dict, name_as_prefix: bool = True):
        ...
        if len(self.config.mcpServers) == 1:
            ...
            # above.
            from ha_mcp._vendor.mcp.server.request_state import (
    ...
    async def _create_proxy(
        ...
        from ha_mcp._vendor.fastmcp.server.providers.proxy import StatefulProxyClient
        from ha_mcp._vendor.fastmcp.server.server import create_proxy
        ...
        if tool_transforms:
            from ha_mcp._vendor.fastmcp.server.transforms import ToolTransform
