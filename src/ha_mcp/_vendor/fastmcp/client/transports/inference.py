...
from ha_mcp._vendor.fastmcp.client.transports.base import ClientTransport, ClientTransportT
...
from ha_mcp._vendor.fastmcp.mcp_config import MCPConfig, infer_transport_type_from_url
...
def _is_fastmcp_server(transport: object) -> bool:
    ...
    try:
        from ha_mcp._vendor.fastmcp.server.server import FastMCP as FastMCP2Server
    except ImportError:
        return False
