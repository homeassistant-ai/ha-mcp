...
from ha_mcp._vendor.mcp import ClientSession, MCPError
from ha_mcp._vendor.mcp.client._input_required import (
...
from ha_mcp._vendor.mcp.client.client import (
...
from ha_mcp._vendor.mcp_types.methods import validate_server_result
from ha_mcp._vendor.mcp_types.version import HANDSHAKE_PROTOCOL_VERSIONS, MODERN_PROTOCOL_VERSIONS
from pydantic import AnyUrl, ValidationError

import ha_mcp._vendor.fastmcp as fastmcp
from ha_mcp._vendor.fastmcp.client.auth.oauth import OAuth
from ha_mcp._vendor.fastmcp.client.elicitation import (
    ElicitationHandler,
    create_elicitation_callback,
)
from ha_mcp._vendor.fastmcp.client.extension_hooks import build_internal_client_extensions
from ha_mcp._vendor.fastmcp.client.logging import (
    LogHandler,
    create_log_callback,
    default_log_handler,
)
from ha_mcp._vendor.fastmcp.client.messages import MessageHandler, MessageHandlerT
from ha_mcp._vendor.fastmcp.client.mixins import (
    ClientPromptsMixin,
    ClientResourcesMixin,
    ClientToolsMixin,
)
from ha_mcp._vendor.fastmcp.client.progress import ProgressHandler, default_progress_handler
from ha_mcp._vendor.fastmcp.client.roots import (
    RootsHandler,
    RootsList,
    create_roots_callback,
)
from ha_mcp._vendor.fastmcp.client.sampling import (
    SamplingHandler,
    create_sampling_callback,
)
from ha_mcp._vendor.fastmcp.mcp_config import MCPConfig
from ha_mcp._vendor.fastmcp.utilities.exceptions import get_catch_handlers
from ha_mcp._vendor.fastmcp.utilities.logging import get_logger
from ha_mcp._vendor.fastmcp.utilities.timeout import normalize_timeout_to_seconds

if TYPE_CHECKING:
    from ha_mcp._vendor.fastmcp.server import FastMCP
else:
    FastMCP = Any
