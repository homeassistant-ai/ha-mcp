        ...
        **OUTPUT:**
        ...
        return {
            ...
            "instructions": (
                ...
                "`missing_tool_hint` field. The most likely cause is a stale tool "
                "list on the MCP client, which caches tools at connect time and "
                "won't show newly enabled ones until refreshed. Ask the user to "
                "refresh their MCP connection (refresh the connector, or "
                "disconnect/reconnect; in Claude Code run /mcp and reconnect) and "
                "re-check. Only continue with this report if the tool is still "
