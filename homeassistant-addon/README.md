...
This add-on enables Claude, ChatGPT, and other AI assistants to control your Home Assistant installation. It provides 80+ tools for device control, automation management, entity search, calendars, todo lists, dashboards, and more.
